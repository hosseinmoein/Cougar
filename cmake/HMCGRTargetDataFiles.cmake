...
# when needed.
#
#    hmcgr_target_data_files(
#        <target>
#        [DATA_FILES <files_path_list>]
#    )
#
#=======================================================================
function(hmcgr_target_data_files targetName)
    set(prefix ARG)
    set(noValues "")
    set(singleValues "")
    ...
    foreach(_data_file IN LISTS ARG_DATA_FILES)
        ...
        set(_data_file_target hmcgr_copy_${_data_file_name})
        ...
        if(TARGET hmcgr_copy_all_data_files)
            add_dependencies(hmcgr_copy_all_data_files ${_data_file_target})
        else()
            add_custom_target(hmcgr_copy_all_data_files DEPENDS ${_data_file_target})
        endif()
    endforeach()
endfunction()
